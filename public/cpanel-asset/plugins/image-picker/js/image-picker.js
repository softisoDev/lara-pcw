    ...
    ImagePickerOption = function () {
        ...
        _createClass(ImagePickerOption, [{
            ...
            value: function create_node() {
                ...
                if (this.opts.show_label && !this.opts.isForProductImport) {
                    thumbnail.append(jQuery("<p class='text-center'>").html(this.label()));
                }
                if (this.opts.isForProductImport && this.opts.show_label) {
                    thumbnail.append(jQuery("<p class='text-center' onclick='setAsPrimaryImage(this, event)'>").html(this.label()));
                }
