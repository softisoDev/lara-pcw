var Ziggy = {
    namedRoutes: {
        "front.home": {"uri": "\/", "methods": ["GET", "HEAD"], "domain": null},
        "front.search": {"uri": "search", "methods": ["GET", "HEAD"], "domain": null},
        "front.search.do": {"uri": "search\/{query}", "methods": ["GET", "HEAD"], "domain": null},
        "front.category.show": {"uri": "{slugCategory}-{category}", "methods": ["GET", "HEAD"], "domain": null},
        "front.product.show": {"uri": "products\/{product}-{slugProduct}", "methods": ["GET", "HEAD"], "domain": null},
        "front.product.similar": {
            "uri": "products\/{product}\/{category}\/similar",
            "methods": ["POST"],
            "domain": null
        },
        "front.tag.show": {"uri": "{tag}", "methods": ["GET", "HEAD"], "domain": null},
        "front.review.load.more": {"uri": "review\/load-more\/{productId}", "methods": ["POST"], "domain": null}
    },
    baseUrl: 'http://larapcw.test/',
    baseProtocol: 'http',
    baseDomain: 'larapcw.test',
    basePort: false,
    defaultParameters: []
};
