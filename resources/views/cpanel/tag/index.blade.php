                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#main" role="tab">
                                <span class="hidden-sm-up">
                                    <i class="ti-home"></i></span> <span class="hidden-xs-down"><i class="fa fa-sitemap"></i> Tags
                                </span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#trash" role="tab">
                                <span class="hidden-sm-up">
                                    <i class="ti-user"></i></span> <span class="hidden-xs-down"><i class="fa fa-trash-o"></i> Trashed
                                </span>
                            </a>
                        </li>
                    ...
                    <div class="tab-content tabcontent-border">
                        ...
                        <div class="tab-pane active p-10" id="main" role="tabpanel">
                            ...
                            <div class="table-responsive text-nowrap">
                                <a href="{{addSlash2Url(route('admin.tag.create'))}}" target="_blank" class="btn btn-sm btn-primary  pull-right"><i class="fa fa-plus"></i> Create new tag</a>
...
@push('add-script')
    ...
    <script src="{{asset('cpanel-asset/js/pages/tag_index.js')}}"></script>
@endpush
